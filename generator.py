...
for i in range(len(fiveof50)):
    print('Number:', fiveof50[i], 'This number accured ', freq[fiveof50[i]-1], ' times.' )

print('\n2 out of 10:\n')
for i in range(len(twoof10)):
    print('Number:', twoof10[i], 'This number accured ', freq[twoof10[i]+49], ' times.' )
...
if 'j' in in1:
    ...
    output=['5 out of 50:\n']
    for i in range(len(fiveof50)):
        output.append('Number: '+str(fiveof50[i])+' This number accured '+str(freq[fiveof50[i]-1])+' times.\n')
    output.append('\n2 out of 10:\n')
    for i in range(len(twoof10)):
        output.append('Number: '+str(twoof10[i])+' This number accured '+str(freq[twoof10[i]+49])+' times.\n')
    output.append('\nThe statistic is based on ' + total +' drawings of lots.')
